...
#ifndef FORCOMPONENT_HPP_
#define FORCOMPONENT_HPP_

#include "../AComponent.hpp"

namespace nts {
    class ForComponent : public AComponent{
        public:
            Tristate compute(std::size_t pin) override {
                ...
                if (pin == 3 || pin == 10 || pin == 4 || pin == 11) {
                    ...
                    || (link1->compute(this->getPin(pin1)) == UNDEFINED && link2->compute(this->getPin(pin2)) == UNDEFINED))
                        return UNDEFINED;
