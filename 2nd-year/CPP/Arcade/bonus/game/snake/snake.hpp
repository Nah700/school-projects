...
class Snake : public arcade::AGameModule {
    public:
        ...
        void musicClear();
        void restartMusic(libvlc_media_player_t *player);
    ...
    private:
        ...
        libvlc_media_t *fraise;
        libvlc_media_t *theme;
        libvlc_media_t *nncbon;
        libvlc_media_t *tropbon;
        libvlc_media_t *dead;
        libvlc_media_player_t *fraisePlayer;
        libvlc_media_player_t *themePlayer;
        libvlc_media_player_t *nncbonPlayer;
        libvlc_media_player_t *tropbonPlayer;
        libvlc_media_player_t *deadPlayer;
